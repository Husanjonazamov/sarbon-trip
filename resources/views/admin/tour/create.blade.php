...
<div class="">
  <div class="">
    ...
    <div class="card p-2">
      <div class="">
        <a href="" class="">
          <h2 class="brand-text text-primary">{{__('Create type')}}</h2>
        </a>

        <form class="form-group" method="POST" action="{{ route('admin.tour.store') }}" enctype="multipart/form-data">
        @method('PUT')  
        @csrf
        <div class="row">
            <div class="form-group col-lg">
                <label for="register-title[uz]" class="form-label"><b>{{__('Title')}} (uz)<b style="color: rgb(255, 0, 0)">*</b></b></label>
                <input type="text" class="form-control @error('title[uz]') is-invalid @enderror" id="register-title[uz]" name="title[uz]" placeholder="title[uz]" aria-describedby="register-title[uz]" tabindex="1" autofocus value="{{ old('title[uz]') }}" />
                @error('title[uz]')
            ...
            <div class="form-group col-lg">
                ...
                <input type="text" class="form-control @error('title[ru]') is-invalid @enderror" id="register-title[ru]" name="title[ru]" placeholder="title[ru]" aria-describedby="register-title[ru]" tabindex="1" autofocus value="{{ old('title[ru]') }}" />
                @error('title[ru]')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group col-lg">
                ...
                <input type="text" class="form-control @error('title[en]') is-invalid @enderror" id="register-title[en]" name="title[en]" placeholder="title[en]" aria-describedby="register-title[en]" tabindex="1" autofocus value="{{ old('title[en]') }}" />
                @error('title[en]')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group col-lg">
                ...
                <input type="text" class="form-control @error('location') is-invalid @enderror" id="register-location" name="location" placeholder="location" aria-describedby="register-location" tabindex="1" autofocus value="{{ old('location') }}" />
                @error('location')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
        ...
        <div class="row">
            <div class="form-group col-lg">
                ...
                <input type="text" class="form-control @error('time') is-invalid @enderror" id="register-time" name="time" placeholder="time" aria-describedby="register-time" tabindex="1" autofocus value="{{ old('time') }}" />
                @error('time')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
            ...
            <div class="form-group col-lg">
                ...
                <input type="text" class="form-control @error('price') is-invalid @enderror" id="register-price" name="price" placeholder="price" aria-describedby="register-price" tabindex="1" autofocus value="{{ old('price') }}" />
                @error('price')
                  <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                  </span>
        ...
        <div class="row">
          ...
          <div class="form-group col-lg">
            ...
            <select status="text" class="form-control @error('status') is-invalid @enderror" id="register-status" name="status" placeholder="status" aria-describedby="register-status" tabindex="1" autofocus value="{{ old('status') }}">
