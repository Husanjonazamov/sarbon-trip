...
<div class="">
  <div class="">
    ...
    <div class="card p-2">
      <div class="">
        <a href="" class="">
          <h2 class="brand-text text-primary">{{__('Edit image')}}</h2>
        </a>

        <form class="form-group" method="POST" action="{{ route('admin.media.update',['id' => $item->id]) }}" enctype="multipart/form-data">
        @method('PUT')  
        @csrf
        <div class="row">
